<template>
  <div id="container">
    <div class="sectionColumn">
      <div class="sectionItem" :style="{ marginLeft: '30px' }">
        <div class="title">
          <TextVue
            :color="'black'"
            :contents="'내 정보'"
          ...
          <div id="myInfo">
            ...
            <div id="row">
              ...
              <button id="editButton">
                <span id="text">개인정보 수정</span>
              </button>
            </div>
          </div>
        </div>
      </div>
      <div class="sectionItem" :style="{ marginRight: '30px' }">
        <div class="title">
          <TextVue
            :color="'black'"
            :contents="'회원 내역'"
    ...
    <div id="navigateColumn">
      ...
      <button class="navigateButton">
        <nuxt-link to="/myinfo/apply">
          <TextVue
            :color="$route.name === 'myinfo-index-apply' ? 'black' : '#CECECE'"
            :contents="'지원현황'"
            :size="18"
            :weight="'bold'"
          ></TextVue
      ...
      ><button class="navigateButton">
        <nuxt-link to="/myinfo/study">
          <TextVue
            :color="$route.name === 'myinfo-index-study' ? 'black' : '#CECECE'"
            :contents="'스터디'"
            :size="18"
            :weight="'bold'"
          ></TextVue
